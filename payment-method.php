...
header('location:login.php');
	...
	if (isset($_POST['submit'])) {
		...
		elseif($_POST['paymethod']=="UPI"){
			header('location:upi-payment.php');
		}
	
		else {

			mysqli_query($con,"update orders set 	paymentMethod='".$_POST['paymethod']."', TxnID=0 where userId='".$_SESSION['id']."' and paymentMethod is null ");
			unset($_SESSION['cart']);
...
<html lang="en">
	<head>
	    ...
	    <title>We Care Online Store | Payment Method</title>
...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="COD" checked="checked"> COD
	     <input type="radio" name="paymethod" value="UPI"> UPI/Net-Banking
