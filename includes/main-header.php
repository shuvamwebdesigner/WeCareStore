...
<style>
	...
	<div class="main-header">
		<div class="container">
			<div class="row">
				<div class="col-xs-3 col-sm-12 col-md-3 col-lg-3 logo-holder">
					<!-- ============================================================= LOGO ============================================================= -->
<div class="logo">
	<a href="index.php">
		
		<img src="assets/images/title_logo.png" alt="Logo" width="25%">
			<span style="vertical-align: middle;">
				<img src="assets/images/logo_name.png" alt="Logo" width="45%">
			</span>

	</a>
</div>		
</div>
<div class="col-xs-6s col-sm-12 col-md-6 col-lg-6 top-search-holder">
...
<!-- ============================================================= SEARCH AREA : END ============================================================= -->				</div><!-- /.top-search-holder -->
				...
				<div class="col-xs-3 col-sm-12 col-md-3 col-lg-3 animate-dropdown top-cart-row">
