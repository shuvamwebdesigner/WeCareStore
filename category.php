...
?>
<script>
	function sort_product_drop(cid){
    var sort_product_id=jQuery('#sort_product_id').val();
    window.location.href="category.php?cid="+cid+"&sort="+sort_product_id;
}
</script>
...
<div>
	<i>Sort By:
	<select onchange="sort_product_drop('<?php echo $cid ?>')" id="sort_product_id">
		...
		<option value="new_first"<?php echo $new_first_selected ?>>Newest First</option>
	</select>
	</i>
</div>
	...
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane active " id="grid-container">
			<div class="category-product  inner-top-vs">
				<div class="row">									
				<?php
$ret=mysqli_query($con,"select * from products where category='$cid' $sort_order");
...
{?>							
	...
	<div class="product" style="left: 10%;">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="auto" height="150"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
