...
//print_r($_SESSION['pid'])=$pdtid;exit;
	?>
				...
				<tr>
					<td class="romove-item"><button class="btn btn-danger btn-sm remove" name="remove_code[]" value="<?php echo htmlentities($row['id']);?>" />
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Sub Total<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
